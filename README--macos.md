...
* Only enable this configuration in environments where the SSH configuration is **managed and trusted**.
* The referenced script should always be **reviewable and maintained by the organization**.
